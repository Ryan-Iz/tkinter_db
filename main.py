...
#Call root here
root = Tk()
#We will make the title of our app Image Viewer
root.title("Database App")
#Geometry of box that will be displayed on the screen
...
def edit():
    ...
    #Create Global Var for text box names
...
def query():
    ...
    print_records = ''
    for record in records:
        print_records += str(record[0]) + " " + str(record[0:7]) +  "\n"
        #print_records.strip('')
        #print_records.strip('')
